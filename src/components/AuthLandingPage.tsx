...
import { Sparkles, ShieldCheck, ArrowRight, User, Mail, Lock, Check, Store, Scissors, EyeOff, Layers, LogIn, UserPlus } from 'lucide-react';
...
export const AuthLandingPage: React.FC<AuthLandingPageProps> = ({
  ...
  const handleCredentialSubmit = (e: React.FormEvent) => {
    ...
    if (authMode === 'register') {
      ...
      // Move to modesty profile setup step
      setStep('profile_setup');
    } else {
      // Login directly with saved or default profile
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#F2EDE6] font-sans selection:bg-[#B89A8E] selection:text-white overflow-y-auto">
      
      {/* Container Box */}
      <div className="relative w-full max-w-xl bg-[#FAF7F2] border border-[#D6CFCE] rounded-3xl shadow-2xl overflow-hidden flex flex-col text-[#4B3F38] my-8">
        ...
        <div className="bg-[#F2EDE6] p-8 border-b border-[#D6CFCE] text-center relative">
          ...
          <h1 className="font-serif italic text-3xl font-bold tracking-tight text-[#4B3F38]">
            hercloset
          </h1>
          ...
          <p className="text-xs text-[#4B3F38]/80 font-sans mt-2 max-w-md mx-auto leading-relaxed">
            Scan live Urban Planet &amp; Ardene Canada catalogs with personalized modesty computer vision audits.
          </p>
