...
import { Sparkles, Search, SlidersHorizontal, ShieldCheck, AlertTriangle, Store, Sun, Moon, Filter } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-[#FAF7F2]/95 dark:bg-[#241E1B]/95 backdrop-blur-md border-b border-[#D6CFCE] dark:border-[#443732] text-[#4B3F38] dark:text-[#F2EDE6] shadow-sm transition-colors">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          {/* Sleek Filter Modesty Rules Button + Controls */}
          <div className="flex items-center gap-2.5">
            {/* Filter Modesty Rules Trigger Button */}
            <button
              onClick={onOpenFiltersDrawer}
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#8A6B5D] hover:bg-[#4B3F38] dark:hover:bg-[#A38071] text-white font-bold text-xs shadow-md transition-all hover:scale-105 active:scale-95 border border-[#B89A8E] dark:border-[#8A6B5D]"
            >
