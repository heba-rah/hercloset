...
export const ModestyStylistAvatar: React.FC<ModestyStylistAvatarProps> = ({
  ...
  return (
    <div className="break-inside-avoid mb-4 inline-block w-full p-4 rounded-3xl bg-[#FAF7F2]/80 border border-[#D6CFCE]/80 backdrop-blur-sm shadow-sm font-sans">

      {/* Inner flex column for tile items */}
